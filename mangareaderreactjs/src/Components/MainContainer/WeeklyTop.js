...
class WeeklyTop extends Component {
    render() {
        ...
        <div className="trending-title">
          <p>Tops of the week</p>
          <div className="temp">
            <h1>Weekly Top</h1>
            <a href={this.propsWeeklyTopLink} style={{fontFamily: 'monospace', fontSize: 16, fontWeight: 'bold', color: 'rgb(0, 183, 255)'}}>View all</a>
          </div>
        </div>
        <div className="trending-wrapper">
          <div className="col-3">
            ...
            <div className="trending-content">
              <a href={this.propsWeeklyTopLink} className="trending-up">Manga 1</a>
              <a href={this.propsWeeklyTopLink} className="trending-down">Chapter 1</a>
            </div>
          </div>
          <div className="col-3">
